...
local function createGUI()
    ...
    gradientFrame.BackgroundColor3 = Color3.fromRGB(25, 20, 40)
    ...
    titleLabel.TextStrokeColor3 = Color3.fromRGB(200, 0, 255)
    ...
    local categories = {
        {name = "⚡ БОЕВЫЕ", color = Color3.fromRGB(255, 50, 50)},
        {name = "🌀 УТИЛИТЫ", color = Color3.fromRGB(50, 200, 255)},
        {name = "💀 ЧИТЫ", color = Color3.fromRGB(200, 0, 255)},
        {name = "🎯 АИМ", color = Color3.fromRGB(255, 200, 0)}
    }
    ...
    for i, cat in ipairs(categories) do
        ...
        tabBtn.BackgroundColor3 = (i == currentCategory) and cat.color or Color3.fromRGB(40, 30, 60)
        ...
        tabBtn.MouseButton1Click:Connect(function()
            ...
            for j, btn in ipairs(categoryButtons) do
                btn.BackgroundColor3 = (j == i) and categories[j].color or Color3.fromRGB(40, 30, 60)
            end
            updateButtons()
        end)
